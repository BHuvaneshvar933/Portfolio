...
const HeroSection = () => (
  <section
    id="home"
    className="w-full hero bg-gradient-to-r text-white h-screen flex flex-col justify-center items-center text-center relative px-7 mt-24 max-sm:mt-28"
  >
    <h1
  ...
  download
  className="px-4 mt-4 py-3 w-full md:w-40 max-sm:mt-1 shadow-md hover:bg-purple-700 transition bg-white rounded-full text-lg font-semibold hoverScale bg-gradient-to-r from-purple-500 to-purple-900 text-white shadow-neon hover:shadow-neon-hover"
  id="neon-button"
>
  Download Resume
</a>
